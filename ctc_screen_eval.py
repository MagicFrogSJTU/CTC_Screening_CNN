        ...
        try:
            ...
            while step < number_of_samples and not coord.should_stop():
                [size_true1, size_false1, size_true2, size_false2,
                 size_true3, size_false3, size_total] = sess.run([size_of_true_positive1, size_of_false_positive1,
                      size_of_true_positive2, size_of_false_positive2, size_of_true_positive3, size_of_false_positive3,
                                                               size_of_positive])
                #print("%d: %f, %f, %f" %(step, size_true2, size_false2, size_total))
                size_true_total1 += size_true1
                size_false_total1 += size_false1
                size_true_total2 += size_true2
                size_false_total2 += size_false2
                size_true_total3 += size_true3
                size_false_total3 += size_false3
                size += size_total
                step += 1
                if size_true1>0:
                    AtLeastOneDot1+=1.0
            ...
            # Compute precision @ 1.
            ratio_true_aver1 = size_true_total1 / size
            ratio_false_aver1 = size_false_total1 / size
            ratio_atleastonedot1 = AtLeastOneDot1 / step
            ratio_true_aver2 = size_true_total2 / size
            ratio_false_aver2 = size_false_total2 / size
            ratio_atleastonedot2 = AtLeastOneDot2 / step
            ratio_true_aver3 = size_true_total3 / size
            ratio_false_aver3 = size_false_total3 / size
